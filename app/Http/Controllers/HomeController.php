...
{ 
    ...
    */
    ...
    public function itServices()
    {
        ...
        return view('front.itServices', compact('services'));
    }
    ...
    public function businessDevelopment()
    {
        ...
        return view('front.businessDevelopment', compact('services'));
    }
    ...
    public function softwareDevelopment()
    {
        ...
        return view('front.softwareDevelopment', compact('services'));
    }
    ...
    public function digitalMarketing()
    {
        ...
        return view('front.digitalMarketing' , compact('services'));
    }
